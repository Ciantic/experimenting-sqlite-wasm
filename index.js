// <define:Deno>
var define_Deno_default = { build: { os: "browser" } };

// ../../../Users/jarip/AppData/Local/deno/deno_esbuild/@sqlite.org/sqlite-wasm@3.42.0-build2/node_modules/@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3-bundler-friendly.mjs
var sqlite3InitModule = (() => {
  ...
  return function(config) {
    ...
    var FS = {
      ...
      saveFilesToDB: (paths, onload, onerror) => {
        ...
        openRequest.onupgradeneeded = () => {
          out("creating db");
          var db2 = openRequest.result;
          db2.createObjectStore(FS.DB_STORE_NAME);
        };
        openRequest.onsuccess = () => {
          var db2 = openRequest.result;
          var transaction = db2.transaction([FS.DB_STORE_NAME], "readwrite");
      ...
      loadFilesFromDB: (paths, onload, onerror) => {
        ...
        openRequest.onsuccess = () => {
          var db2 = openRequest.result;
          try {
            var transaction = db2.transaction([FS.DB_STORE_NAME], "readonly");
          } catch (e) {
            onerror(e);
            return;
          }
    ...
    var _sqlite3_wasm_kvvfsMakeKeyOnPstack = Module["_sqlite3_wasm_kvvfsMakeKeyOnPstack"] = function() {
      return (_sqlite3_wasm_kvvfsMakeKeyOnPstack = Module["_sqlite3_wasm_kvvfsMakeKeyOnPstack"] = Module["asm"]["sqlite3_wasm_kvvfsMakeKeyOnPstack"]).apply(
        null,
        arguments
      );
    };
    ...
    var _sqlite3_wasm_test_stack_overflow = Module["_sqlite3_wasm_test_stack_overflow"] = function() {
      return (_sqlite3_wasm_test_stack_overflow = Module["_sqlite3_wasm_test_stack_overflow"] = Module["asm"]["sqlite3_wasm_test_stack_overflow"]).apply(
        null,
        arguments
      );
    };
    ...
    Module.postRun.push(function(Module2) {
      ...
      globalThis.sqlite3ApiBootstrap = function sqlite3ApiBootstrap(apiConfig = globalThis.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig) {
        ...
        const capi2 = /* @__PURE__ */ Object.create(null);
        const wasm = /* @__PURE__ */ Object.create(null);
        const __rcStr = (rc) => {
          return capi2.sqlite3_js_rc_str && capi2.sqlite3_js_rc_str(rc) || "Unknown result code #" + rc;
        };
        ...
        class SQLite3Error extends Error {
          constructor(...args) {
            ...
            this.resultCode = rc || capi2.SQLITE_ERROR;
        ...
        class WasmAllocError extends Error {
          constructor(...args) {
            ...
            this.resultCode = capi2.SQLITE_NOMEM;
        ...
        wasm.compileOptionUsed = function f(optName) {
          if (!arguments.length) {
            ...
            const rc = {}, ov = [0, 0];
            let i = 0, k;
            while (k = capi2.sqlite3_compileoption_get(i++)) {
              f._opt(k, ov);
              rc[ov[0]] = ov[1];
            }
            return f._result = rc;
            ...
            const rc = {};
            optName.forEach((v) => {
              rc[v] = capi2.sqlite3_compileoption_used(v);
            });
            return rc;
          } else if ("object" === typeof optName) {
            Object.keys(optName).forEach((k) => {
              optName[k] = capi2.sqlite3_compileoption_used(k);
            });
            return optName;
          }
          return "string" === typeof optName ? !!capi2.sqlite3_compileoption_used(optName) : false;
        };
        ...
        capi2.sqlite3_wasmfs_opfs_dir = function() {
        ...
        capi2.sqlite3_wasmfs_filename_is_persistent = function(name) {
          const p = capi2.sqlite3_wasmfs_opfs_dir();
          return p && name ? name.startsWith(p + "/") : false;
        };
        if (false) {
          wasm.exports.sqlite3_initialize();
        }
        capi2.sqlite3_js_db_uses_vfs = function(pDb2, vfsName, dbName = 0) {
          try {
            const pK = capi2.sqlite3_vfs_find(vfsName);
            if (!pK)
              return false;
            else if (!pDb2) {
              return pK === capi2.sqlite3_vfs_find(0) ? pK : false;
            } else {
              return pK === capi2.sqlite3_js_db_vfs(pDb2, dbName) ? pK : false;
            }
          } catch (e) {
            return false;
          }
        };
        capi2.sqlite3_js_vfs_list = function() {
          const rc = [];
          let pVfs = capi2.sqlite3_vfs_find(0);
          while (pVfs) {
            const oVfs = new capi2.sqlite3_vfs(pVfs);
        ...
        capi2.sqlite3_js_db_export = function(pDb2, schema = 0) {
        ...
        capi2.sqlite3_js_db_vfs = (dbPointer, dbName = 0) => wasm.sqlite3_wasm_db_vfs(dbPointer, dbName);
        capi2.sqlite3_js_aggregate_context = (pCtx, n) => {
          return capi2.sqlite3_aggregate_context(pCtx, n) || (n ? WasmAllocError.toss(
            "Cannot allocate",
            n,
            "bytes for sqlite3_aggregate_context()"
          ) : 0);
        };
        capi2.sqlite3_js_vfs_create_file = function(vfs, filename, data, dataLen) {
          let pData;
          if (data) {
            if (wasm.isPtr(data)) {
              pData = data;
        ...
        if (util.isUIThread()) {
          ...
          capi2.sqlite3_js_kvvfs_clear = function(which = "") {
            let rc = 0;
          ...
          capi2.sqlite3_js_kvvfs_size = function(which = "") {
            let sz = 0;
            const kvinfo = __kvvfsInfo(which);
            kvinfo.stores.forEach((s) => {
              let i;
        ...
        capi2.sqlite3_db_config = function(pDb2, op, ...args) {
          if (!this.s) {
          ...
          switch (op) {
            case capi2.SQLITE_DBCONFIG_ENABLE_FKEY:
            case capi2.SQLITE_DBCONFIG_ENABLE_TRIGGER:
            case capi2.SQLITE_DBCONFIG_ENABLE_FTS3_TOKENIZER:
            case capi2.SQLITE_DBCONFIG_ENABLE_LOAD_EXTENSION:
            case capi2.SQLITE_DBCONFIG_NO_CKPT_ON_CLOSE:
            case capi2.SQLITE_DBCONFIG_ENABLE_QPSG:
            case capi2.SQLITE_DBCONFIG_TRIGGER_EQP:
            case capi2.SQLITE_DBCONFIG_RESET_DATABASE:
            case capi2.SQLITE_DBCONFIG_DEFENSIVE:
            case capi2.SQLITE_DBCONFIG_WRITABLE_SCHEMA:
            case capi2.SQLITE_DBCONFIG_LEGACY_ALTER_TABLE:
            case capi2.SQLITE_DBCONFIG_DQS_DML:
            case capi2.SQLITE_DBCONFIG_DQS_DDL:
            case capi2.SQLITE_DBCONFIG_ENABLE_VIEW:
            case capi2.SQLITE_DBCONFIG_LEGACY_FILE_FORMAT:
            case capi2.SQLITE_DBCONFIG_TRUSTED_SCHEMA:
            case capi2.SQLITE_DBCONFIG_STMT_SCANSTATUS:
            case capi2.SQLITE_DBCONFIG_REVERSE_SCANORDER:
              return this.ip(pDb2, op, args[0], args[1] || 0);
            case capi2.SQLITE_DBCONFIG_LOOKASIDE:
              return this.pii(pDb2, op, args[0], args[1], args[2]);
            case capi2.SQLITE_DBCONFIG_MAINDBNAME:
              return this.s(pDb2, op, args[0]);
            default:
              return capi2.SQLITE_MISUSE;
          }
        }.bind(/* @__PURE__ */ Object.create(null));
        capi2.sqlite3_value_to_js = function(pVal, throwIfCannotConvert = true) {
          let arg;
          const valType = capi2.sqlite3_value_type(pVal);
          switch (valType) {
            case capi2.SQLITE_INTEGER:
              if (wasm.bigIntEnabled) {
                arg = capi2.sqlite3_value_int64(pVal);
                if (util.bigIntFitsDouble(arg))
                  arg = Number(arg);
              } else
                arg = capi2.sqlite3_value_double(pVal);
              break;
            case capi2.SQLITE_FLOAT:
              arg = capi2.sqlite3_value_double(pVal);
              break;
            case capi2.SQLITE_TEXT:
              arg = capi2.sqlite3_value_text(pVal);
              break;
            case capi2.SQLITE_BLOB: {
              const n = capi2.sqlite3_value_bytes(pVal);
              const pBlob = capi2.sqlite3_value_blob(pVal);
              if (n && !pBlob)
            ...
            case capi2.SQLITE_NULL:
              arg = null;
              break;
            default:
              if (throwIfCannotConvert) {
                toss3(
                  capi2.SQLITE_MISMATCH,
        ...
        capi2.sqlite3_values_to_js = function(argc, pArgv, throwIfCannotConvert = true) {
          let i;
          const tgt = [];
          for (i = 0; i < argc; ++i) {
            tgt.push(
              capi2.sqlite3_value_to_js(
        ...
        capi2.sqlite3_result_error_js = function(pCtx, e) {
          if (e instanceof WasmAllocError) {
            capi2.sqlite3_result_error_nomem(pCtx);
          } else {
            capi2.sqlite3_result_error(pCtx, "" + e, -1);
          }
        };
        capi2.sqlite3_result_js = function(pCtx, val) {
          if (val instanceof Error) {
            capi2.sqlite3_result_error_js(pCtx, val);
            return;
          }
          try {
            switch (typeof val) {
              case "undefined":
                break;
              case "boolean":
                capi2.sqlite3_result_int(pCtx, val ? 1 : 0);
                break;
              case "bigint":
                if (util.bigIntFits32(val)) {
                  capi2.sqlite3_result_int(pCtx, Number(val));
                } else if (util.bigIntFitsDouble(val)) {
                  capi2.sqlite3_result_double(pCtx, Number(val));
                } else if (wasm.bigIntEnabled) {
                  if (util.bigIntFits64(val))
                    capi2.sqlite3_result_int64(pCtx, val);
                  else
                    toss3(
                      "BigInt value",
                      val.toString(),
              ...
              case "number": {
                let f;
                if (util.isInt32(val)) {
                  f = capi2.sqlite3_result_int;
                } else if (wasm.bigIntEnabled && Number.isInteger(val) && util.bigIntFits64(BigInt(val))) {
                  f = capi2.sqlite3_result_int64;
                } else {
                  f = capi2.sqlite3_result_double;
                }
                f(pCtx, val);
                break;
              }
              case "string": {
                ...
                capi2.sqlite3_result_text(pCtx, p, n, capi2.SQLITE_WASM_DEALLOC);
                break;
              }
              case "object":
                if (null === val) {
                  capi2.sqlite3_result_null(pCtx);
                  break;
                } else if (util.isBindableTypedArray(val)) {
                  const pBlob = wasm.allocFromTypedArray(val);
                  capi2.sqlite3_result_blob(
                    pCtx,
                    pBlob,
                    val.byteLength,
                    capi2.SQLITE_WASM_DEALLOC
                  );
                  break;
                }
              default:
            ...
            capi2.sqlite3_result_error_js(pCtx, e);
          }
        };
        capi2.sqlite3_column_js = function(pStmt, iCol, throwIfCannotConvert = true) {
          const v = capi2.sqlite3_column_value(pStmt, iCol);
          return 0 === v ? void 0 : capi2.sqlite3_value_to_js(v, throwIfCannotConvert);
        };
        const __newOldValue = function(pObj, iCol, impl) {
          ...
          return pv ? capi2.sqlite3_value_to_js(pv, true) : void 0;
        }.bind(/* @__PURE__ */ Object.create(null));
        capi2.sqlite3_preupdate_new_js = (pDb2, iCol) => __newOldValue(pDb2, iCol, "sqlite3_preupdate_new");
        capi2.sqlite3_preupdate_old_js = (pDb2, iCol) => __newOldValue(pDb2, iCol, "sqlite3_preupdate_old");
        capi2.sqlite3changeset_new_js = (pChangesetIter, iCol) => __newOldValue(pChangesetIter, iCol, "sqlite3changeset_new");
        capi2.sqlite3changeset_old_js = (pChangesetIter, iCol) => __newOldValue(pChangesetIter, iCol, "sqlite3changeset_old");
        const sqlite32 = {
          WasmAllocError,
          SQLite3Error,
          capi: capi2,
          ...
          asyncPostInit: async function() {
            ...
            lip = lip.map((f) => {
              const p = f instanceof Promise ? f : f(sqlite32);
              return p.catch((e) => {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
        ...
        const capi2 = sqlite32.capi, wasm = sqlite32.wasm, util = sqlite32.util;
        ...
        if (0) {
          ...
          for (i = 0; i < nFunc; ++i) {
            ...
            if (dealloc === e) {
              capi2.SQLITE_WASM_DEALLOC = i;
              break;
            }
          }
          if (dealloc !== wasm.functionEntry(capi2.SQLITE_WASM_DEALLOC)) {
            toss(
                ...
                callProxy: (callback) => {
                  ...
                  return (pVoid, nCols, pColVals, pColNames) => {
                    try {
                      ...
                      return e.resultCode || capi2.SQLITE_ERROR;
                    }
                  };
                }
              }),
        ...
        delete globalThis.Jaccwabyt;
        {
          ...
          wasm.xWrap.argAdapter("sqlite3_filename", __xArgPtr)(
            ...
            "sqlite3_stmt*",
            (v) => __xArgPtr(
              v instanceof (sqlite32?.oo1?.Stmt || nilType) ? v.pointer : v
            )
          )(
            "sqlite3*",
            (v) => __xArgPtr(
              v instanceof (sqlite32?.oo1?.DB || nilType) ? v.pointer : v
            )
          )(
            "sqlite3_index_info*",
            (v) => __xArgPtr(
              v instanceof (capi2.sqlite3_index_info || nilType) ? v.pointer : v
            )
          )(
            "sqlite3_module*",
            (v) => __xArgPtr(
              v instanceof (capi2.sqlite3_module || nilType) ? v.pointer : v
            )
          )("sqlite3_vfs*", (v) => {
            if ("string" === typeof v) {
              return capi2.sqlite3_vfs_find(v) || sqlite32.SQLite3Error.toss(
                capi2.SQLITE_NOTFOUND,
                "Unknown sqlite3_vfs name:",
                v
              );
            }
            return __xArgPtr(
              v instanceof (capi2.sqlite3_vfs || nilType) ? v.pointer : v
            );
          });
          ...
          for (const e of wasm.bindingSignatures) {
            capi2[e[0]] = wasm.xWrap.apply(null, e);
          }
          ...
          for (const e of wasm.bindingSignatures.int64) {
            capi2[e[0]] = wasm.bigIntEnabled ? wasm.xWrap.apply(null, e) : fI64Disabled(e[0]);
          }
          ...
          if (wasm.exports.sqlite3_wasm_db_error) {
            ...
            util.sqlite3_wasm_db_error = function(pDb2, resultCode, message) {
              if (resultCode instanceof sqlite32.WasmAllocError) {
                resultCode = capi2.SQLITE_NOMEM;
                message = 0;
              } else if (resultCode instanceof Error) {
                message = message || "" + resultCode;
                resultCode = resultCode.resultCode || capi2.SQLITE_ERROR;
              }
        ...
        }
        {
          ...
          if (!wasm.functionEntry(capi2.SQLITE_WASM_DEALLOC)) {
            toss(
              "Internal error: cannot resolve exported function",
              "entry SQLITE_WASM_DEALLOC (==" + capi2.SQLITE_WASM_DEALLOC + ")."
            );
          }
          ...
          capi2.sqlite3_js_rc_str = (rc) => __rcMap[rc];
          ...
          for (const s of wasm.ctype.structs) {
            if (!notThese[s.name]) {
              capi2[s.name] = sqlite32.StructBinder(s);
            }
          }
          if (capi2.sqlite3_index_info) {
            for (const k of [
              "sqlite3_index_constraint",
              "sqlite3_index_orderby",
              "sqlite3_index_constraint_usage"
            ]) {
              capi2.sqlite3_index_info[k] = capi2[k];
              delete capi2[k];
            }
            capi2.sqlite3_vtab_config = wasm.xWrap(
        ...
        const __dbArgcMismatch = (pDb2, f, n) => {
          return sqlite32.util.sqlite3_wasm_db_error(
            pDb2,
            capi2.SQLITE_MISUSE,
        ...
        __dbCleanupMap.cleanup = function(pDb2) {
          ...
          if (m.collation) {
            for (const name of m.collation) {
              try {
                capi2.sqlite3_create_collation_v2(
                  pDb2,
                  name,
                  capi2.SQLITE_UTF8,
                  0,
          ...
          for (i = 0; i < 2; ++i) {
            ...
            if (!fmap)
              continue;
            const func = i ? capi2.sqlite3_create_window_function : capi2.sqlite3_create_function_v2;
            for (const e of fmap) {
              const name = e[0], arities = e[1];
              const fargs = [pDb2, name, 0, capi2.SQLITE_UTF8, 0, 0, 0, 0, 0];
              if (i)
                fargs.push(0);
        ...
        };
        {
          ...
          capi2.sqlite3_close_v2 = function(pDb2) {
            if (1 !== arguments.length)
        ...
        if (capi2.sqlite3session_table_filter) {
          const __sqlite3SessionDelete = wasm.xWrap(
            "sqlite3session_delete",
            void 0,
            ["sqlite3_session*"]
          );
          capi2.sqlite3session_delete = function(pSession) {
            if (1 !== arguments.length) {
              return __dbArgcMismatch(pDb, "sqlite3session_delete", 1);
            } else if (pSession) {
              capi2.sqlite3session_table_filter(pSession, 0, 0);
            }
        ...
        }
        {
          ...
          capi2.sqlite3_create_collation_v2 = function(pDb2, zName, eTextRep, pArg, xCompare, xDestroy) {
            if (6 !== arguments.length)
              return __dbArgcMismatch(pDb2, "sqlite3_create_collation_v2", 6);
            else if (0 === (eTextRep & 15)) {
              eTextRep |= capi2.SQLITE_UTF8;
            } else if (capi2.SQLITE_UTF8 !== (eTextRep & 15)) {
          ...
          capi2.sqlite3_create_collation = (pDb2, zName, eTextRep, pArg, xCompare) => {
            return 5 === arguments.length ? capi2.sqlite3_create_collation_v2(
              pDb2,
              zName,
              eTextRep,
              pArg,
        ...
        }
        {
          ...
          const __cfProxy = Object.assign(/* @__PURE__ */ Object.create(null), {
            xInverseAndStep: {
              ...
              callProxy: (callback) => {
                return (pCtx, argc, pArgv) => {
                  try {
                    callback(pCtx, ...capi2.sqlite3_values_to_js(argc, pArgv));
                  } catch (e) {
                    capi2.sqlite3_result_error_js(pCtx, e);
                  }
                };
            ...
            xFinalAndValue: {
              ...
              callProxy: (callback) => {
                return (pCtx) => {
                  try {
                    capi2.sqlite3_result_js(pCtx, callback(pCtx));
                  } catch (e) {
                    capi2.sqlite3_result_error_js(pCtx, e);
                  }
                };
          ...
          capi2.sqlite3_create_function_v2 = function f(pDb2, funcName, nArg, eTextRep, pApp, xFunc, xStep, xFinal, xDestroy) {
          ...
          capi2.sqlite3_create_function = function f(pDb2, funcName, nArg, eTextRep, pApp, xFunc, xStep, xFinal) {
            return f.length === arguments.length ? capi2.sqlite3_create_function_v2(
              pDb2,
              funcName,
              nArg,
              eTextRep,
          ...
          capi2.sqlite3_create_window_function = function f(pDb2, funcName, nArg, eTextRep, pApp, xStep, xFinal, xValue, xInverse, xDestroy) {
            if (f.length !== arguments.length) {
              return __dbArgcMismatch(
                pDb2,
                "sqlite3_create_window_function",
          ...
          capi2.sqlite3_create_function_v2.udfSetResult = capi2.sqlite3_create_function.udfSetResult = capi2.sqlite3_create_window_function.udfSetResult = capi2.sqlite3_result_js;
          capi2.sqlite3_create_function_v2.udfConvertArgs = capi2.sqlite3_create_function.udfConvertArgs = capi2.sqlite3_create_window_function.udfConvertArgs = capi2.sqlite3_values_to_js;
          capi2.sqlite3_create_function_v2.udfSetError = capi2.sqlite3_create_function.udfSetError = capi2.sqlite3_create_window_function.udfSetError = capi2.sqlite3_result_error_js;
        }
        {
          ...
          capi2.sqlite3_prepare_v3 = function f(pDb2, sql, sqlLen, prepFlags, ppStmt, pzTail) {
            if (f.length !== arguments.length) {
          ...
          capi2.sqlite3_prepare_v2 = function f(pDb2, sql, sqlLen, ppStmt, pzTail) {
            return f.length === arguments.length ? capi2.sqlite3_prepare_v3(pDb2, sql, sqlLen, 0, ppStmt, pzTail) : __dbArgcMismatch(pDb2, "sqlite3_prepare_v2", f.length);
          };
        }
        {
          ...
          capi2.sqlite3_bind_text = function f(pStmt, iCol, text, nText, xDestroy) {
            if (f.length !== arguments.length) {
              return __dbArgcMismatch(
                capi2.sqlite3_db_handle(pStmt),
                "sqlite3_bind_text",
                f.length
              );
            ...
            try {
              ...
              return __bindText(pStmt, iCol, p, n, capi2.SQLITE_WASM_DEALLOC);
            } catch (e) {
              wasm.dealloc(p);
              return util.sqlite3_wasm_db_error(
                capi2.sqlite3_db_handle(pStmt),
          ...
          capi2.sqlite3_bind_blob = function f(pStmt, iCol, pMem2, nMem, xDestroy) {
            if (f.length !== arguments.length) {
              return __dbArgcMismatch(
                capi2.sqlite3_db_handle(pStmt),
                "sqlite3_bind_blob",
            ...
            try {
              ...
              return __bindBlob(pStmt, iCol, p, n, capi2.SQLITE_WASM_DEALLOC);
            } catch (e) {
              wasm.dealloc(p);
              return util.sqlite3_wasm_db_error(
                capi2.sqlite3_db_handle(pStmt),
        ...
        {
          capi2.sqlite3_config = function(op, ...args) {
            if (arguments.length < 2)
              return capi2.SQLITE_MISUSE;
            switch (op) {
              case capi2.SQLITE_CONFIG_COVERING_INDEX_SCAN:
              case capi2.SQLITE_CONFIG_MEMSTATUS:
              case capi2.SQLITE_CONFIG_SMALL_MALLOC:
              case capi2.SQLITE_CONFIG_SORTERREF_SIZE:
              case capi2.SQLITE_CONFIG_STMTJRNL_SPILL:
              case capi2.SQLITE_CONFIG_URI:
                return wasm.exports.sqlite3_wasm_config_i(op, args[0]);
              case capi2.SQLITE_CONFIG_LOOKASIDE:
                return wasm.exports.sqlite3_wasm_config_ii(
                  op,
                  args[0],
                  args[1]
                );
              case capi2.SQLITE_CONFIG_MEMDB_MAXSIZE:
                return wasm.exports.sqlite3_wasm_config_j(op, args[0]);
              case capi2.SQLITE_CONFIG_GETMALLOC:
              case capi2.SQLITE_CONFIG_GETMUTEX:
              case capi2.SQLITE_CONFIG_GETPCACHE2:
              case capi2.SQLITE_CONFIG_GETPCACHE:
              case capi2.SQLITE_CONFIG_HEAP:
              case capi2.SQLITE_CONFIG_LOG:
              case capi2.SQLITE_CONFIG_MALLOC:
              case capi2.SQLITE_CONFIG_MMAP_SIZE:
              case capi2.SQLITE_CONFIG_MULTITHREAD:
              case capi2.SQLITE_CONFIG_MUTEX:
              case capi2.SQLITE_CONFIG_PAGECACHE:
              case capi2.SQLITE_CONFIG_PCACHE2:
              case capi2.SQLITE_CONFIG_PCACHE:
              case capi2.SQLITE_CONFIG_PCACHE_HDRSZ:
              case capi2.SQLITE_CONFIG_PMASZ:
              case capi2.SQLITE_CONFIG_SERIALIZED:
              case capi2.SQLITE_CONFIG_SINGLETHREAD:
              case capi2.SQLITE_CONFIG_SQLLOG:
              case capi2.SQLITE_CONFIG_WIN32_HEAPSIZE:
              default:
        ...
        }
        {
          ...
          capi2.sqlite3_auto_extension = function(fPtr) {
          ...
          capi2.sqlite3_cancel_auto_extension = function(fPtr) {
            if (!fPtr || 1 !== arguments.length || !wasm.isPtr(fPtr))
              return 0;
            return wasm.exports.sqlite3_cancel_auto_extension(fPtr);
          };
          capi2.sqlite3_reset_auto_extension = function() {
        ...
        const pKvvfs = capi2.sqlite3_vfs_find("kvvfs");
        if (pKvvfs) {
          if (util.isUIThread()) {
            const kvvfsMethods = new capi2.sqlite3_kvvfs_methods(
              wasm.exports.sqlite3_wasm_kvvfs_methods()
            );
            delete capi2.sqlite3_kvvfs_methods;
            ...
            capi2.sqlite3_vfs_unregister(pKvvfs);
          }
        }
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
        ...
        const checkSqlite3Rc = function(dbPtr, sqliteResultCode) {
          if (sqliteResultCode) {
            ...
            toss3(
              "sqlite3 result code",
              sqliteResultCode + ":",
              dbPtr ? capi2.sqlite3_errmsg(dbPtr) : capi2.sqlite3_errstr(sqliteResultCode)
            );
          }
          return arguments[0];
        };
        ...
        const dbCtorHelper = function ctor(...args) {
          ...
          if (flagsStr.indexOf("c") >= 0) {
            oflags |= capi2.SQLITE_OPEN_CREATE | capi2.SQLITE_OPEN_READWRITE;
          }
          if (flagsStr.indexOf("w") >= 0)
            oflags |= capi2.SQLITE_OPEN_READWRITE;
          if (0 === oflags)
            oflags |= capi2.SQLITE_OPEN_READONLY;
          oflags |= capi2.SQLITE_OPEN_EXRESCODE;
          const stack = wasm.pstack.pointer;
          try {
            const pPtr = wasm.pstack.allocPtr();
            let rc = capi2.sqlite3_open_v2(fn, pPtr, oflags, vfsName || 0);
            pDb2 = wasm.peekPtr(pPtr);
            checkSqlite3Rc(pDb2, rc);
            capi2.sqlite3_extended_result_codes(pDb2, 1);
            if (flagsStr.indexOf("t") >= 0) {
              capi2.sqlite3_trace_v2(
                pDb2,
                capi2.SQLITE_TRACE_STMT,
                __dbTraceToConsole,
                pDb2
              );
            }
          ...
          try {
            const pVfs = capi2.sqlite3_js_db_vfs(pDb2);
            if (!pVfs)
            ...
            if (postInitSql instanceof Function) {
              ...
              checkSqlite3Rc(pDb2, capi2.sqlite3_exec(pDb2, postInitSql, 0, 0, 0));
            }
          } catch (e) {
            this.close();
            throw e;
        ...
        const Stmt = function() {
          ...
          this.columnCount = capi2.sqlite3_column_count(this.pointer);
          this.parameterCount = capi2.sqlite3_bind_parameter_count(this.pointer);
        };
        ...
        DB.prototype = {
          ...
          changes: function(total = false, sixtyFour = false) {
            ...
            if (total) {
              return sixtyFour ? capi2.sqlite3_total_changes64(p) : capi2.sqlite3_total_changes(p);
            } else {
              return sixtyFour ? capi2.sqlite3_changes64(p) : capi2.sqlite3_changes(p);
            }
          },
          dbFilename: function(dbName = "main") {
            return capi2.sqlite3_db_filename(affirmDbOpen(this).pointer, dbName);
          },
          dbName: function(dbNumber = 0) {
            return capi2.sqlite3_db_name(affirmDbOpen(this).pointer, dbNumber);
          },
          dbVfsName: function(dbName = 0) {
            let rc;
            const pVfs = capi2.sqlite3_js_db_vfs(
              affirmDbOpen(this).pointer,
              dbName
            );
            if (pVfs) {
              const v = new capi2.sqlite3_vfs(pVfs);
              try {
          ...
          prepare: function(sql) {
            ...
            try {
              ...
              DB.checkRc(
                this,
                capi2.sqlite3_prepare_v2(this.pointer, sql, -1, ppStmt, null)
              );
            ...
            try {
              ...
              while (pSql && wasm.peek(pSql, "i8")) {
                ...
                if (!pStmt)
                  continue;
                if (saveSql)
                  saveSql.push(capi2.sqlite3_sql(pStmt).trim());
          ...
          createFunction: function f(name, xFunc, opt) {
            ...
            if (getOwnOption(opt, "deterministic"))
              fFlags |= capi2.SQLITE_DETERMINISTIC;
            if (getOwnOption(opt, "directOnly"))
              fFlags |= capi2.SQLITE_DIRECTONLY;
            if (getOwnOption(opt, "innocuous"))
              fFlags |= capi2.SQLITE_INNOCUOUS;
            ...
            let rc;
            if (isWindow) {
              rc = capi2.sqlite3_create_window_function(
                this.pointer,
                name,
                arityArg,
                capi2.SQLITE_UTF8 | fFlags,
                pApp || 0,
                xStep,
                xFinal,
                xValue,
              ...
              rc = capi2.sqlite3_create_function_v2(
                this.pointer,
                name,
                arityArg,
                capi2.SQLITE_UTF8 | fFlags,
        ...
        const affirmParamIndex = function(stmt, key) {
          const n = "number" === typeof key ? key : capi2.sqlite3_bind_parameter_index(stmt.pointer, key);
        ...
        const bindOne = function f(stmt, ndx, bindType, val) {
          ...
          if (!f._) {
            ...
            f._ = {
              string: function(stmt2, ndx2, val2, asBlob) {
                ...
                const f2 = asBlob ? capi2.sqlite3_bind_blob : capi2.sqlite3_bind_text;
                return f2(stmt2.pointer, ndx2, pStr, n, capi2.SQLITE_WASM_DEALLOC);
              }
            };
          }
          ...
          switch (null === val || void 0 === val ? BindTypes.null : bindType) {
            case BindTypes.null:
              rc = capi2.sqlite3_bind_null(stmt.pointer, ndx);
              break;
            case BindTypes.string:
            ...
            case BindTypes.number: {
              let m;
              if (util.isInt32(val))
                m = capi2.sqlite3_bind_int;
              else if ("bigint" === typeof val) {
                if (!util.bigIntFits64(val)) {
                  f._tooBigInt(val);
                } else if (wasm.bigIntEnabled) {
                  m = capi2.sqlite3_bind_int64;
                } else if (util.bigIntFitsDouble(val)) {
                  val = Number(val);
                  m = capi2.sqlite3_bind_double;
                } else {
                  f._tooBigInt(val);
                }
              } else {
            ...
            case BindTypes.boolean:
              rc = capi2.sqlite3_bind_int(stmt.pointer, ndx, val ? 1 : 0);
              break;
            case BindTypes.blob: {
        ...
        Stmt.prototype = {
          finalize: function() {
            if (this.pointer) {
              ...
              capi2.sqlite3_finalize(this.pointer);
              __ptrMap.delete(this);
              delete this._mayGet;
          ...
          clearBindings: function() {
            ...
            capi2.sqlite3_clear_bindings(this.pointer);
            this._mayGet = false;
            return this;
          },
          reset: function(alsoClearBinds) {
            ...
            if (alsoClearBinds)
              this.clearBindings();
            capi2.sqlite3_reset(affirmStmtOpen(this).pointer);
            this._mayGet = false;
            return this;
          },
          bind: function() {
          ...
          step: function() {
            ...
            const rc = capi2.sqlite3_step(affirmStmtOpen(this).pointer);
            switch (rc) {
              case capi2.SQLITE_DONE:
                return this._mayGet = false;
              case capi2.SQLITE_ROW:
              ...
              default:
                ...
                sqlite32.config.warn(
                  ...
                  capi2.sqlite3_js_rc_str(rc),
                  "SQL =",
                  capi2.sqlite3_sql(this.pointer)
                );
          ...
          get: function(ndx, asType) {
            ...
            if (Array.isArray(ndx)) {
              ...
              let i = 0;
              while (i < this.columnCount) {
                ndx[capi2.sqlite3_column_name(this.pointer, i)] = this.get(i++);
              }
              return ndx;
            }
            affirmColIndex(this, ndx);
            switch (void 0 === asType ? capi2.sqlite3_column_type(this.pointer, ndx) : asType) {
              case capi2.SQLITE_NULL:
                return null;
              case capi2.SQLITE_INTEGER: {
                if (wasm.bigIntEnabled) {
                  const rc = capi2.sqlite3_column_int64(this.pointer, ndx);
                  if (rc >= Number.MIN_SAFE_INTEGER && rc <= Number.MAX_SAFE_INTEGER) {
                    return Number(rc).valueOf();
                  }
                  return rc;
                } else {
                  const rc = capi2.sqlite3_column_double(this.pointer, ndx);
              ...
              case capi2.SQLITE_FLOAT:
                return capi2.sqlite3_column_double(this.pointer, ndx);
              case capi2.SQLITE_TEXT:
                return capi2.sqlite3_column_text(this.pointer, ndx);
              case capi2.SQLITE_BLOB: {
                const n = capi2.sqlite3_column_bytes(this.pointer, ndx), ptr = capi2.sqlite3_column_blob(this.pointer, ndx), rc = new Uint8Array(n);
                if (n)
          ...
          getInt: function(ndx) {
            return this.get(ndx, capi2.SQLITE_INTEGER);
          },
          getFloat: function(ndx) {
            return this.get(ndx, capi2.SQLITE_FLOAT);
          },
          getString: function(ndx) {
            return this.get(ndx, capi2.SQLITE_TEXT);
          },
          getBlob: function(ndx) {
            return this.get(ndx, capi2.SQLITE_BLOB);
          },
          getJSON: function(ndx) {
            const s = this.get(ndx, capi2.SQLITE_STRING);
            return null === s ? s : JSON.parse(s);
          },
          getColumnName: function(ndx) {
            return capi2.sqlite3_column_name(
          ...
          getColumnNames: function(tgt = []) {
            ...
            for (let i = 0; i < this.columnCount; ++i) {
              tgt.push(capi2.sqlite3_column_name(this.pointer, i));
            }
            return tgt;
          },
          getParamIndex: function(name) {
            return affirmStmtOpen(this).parameterCount ? capi2.sqlite3_bind_parameter_index(this.pointer, name) : void 0;
          }
        };
        {
          const prop = {
        ...
        if (util.isUIThread()) {
          ...
          jdb.clearStorage = capi2.sqlite3_js_kvvfs_clear;
          jdb.prototype.clearStorage = function() {
            return jdb.clearStorage(affirmDbOpen(this).filename);
          };
          jdb.storageSize = capi2.sqlite3_js_kvvfs_size;
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
        sqlite32.initWorker1API = function() {
          ...
          const wState = {
            ...
            open: function(opt) {
              ...
              if (this.dbList.indexOf(db2) < 0)
                this.dbList.push(db2);
              return db2;
            },
            close: function(db2, alsoUnlink) {
              if (db2) {
                ...
                const pVfs = sqlite33.wasm.sqlite3_wasm_db_vfs(db2.pointer, 0);
                db2.close();
                const ddNdx = this.dbList.indexOf(db2);
                if (ddNdx >= 0)
                  this.dbList.splice(ddNdx, 1);
                if (alsoUnlink && filename && pVfs) {
                  sqlite33.wasm.sqlite3_wasm_vfs_unlink(pVfs, filename);
                }
              }
            },
          ...
          const guessVfs = function(filename) {
            ...
            return sqlite33.capi.sqlite3_vfs_find(m ? m[2] : 0);
          };
          ...
          const wMsgHandler = {
            open: function(ev) {
              ...
              if (pVfs) {
                let pMem2;
                try {
                  pMem2 = sqlite33.wasm.allocFromTypedArray(byteArray);
                  const rc2 = sqlite33.wasm.sqlite3_wasm_vfs_create_file(
                    pVfs,
                    oargs.filename,
                    pMem2,
                  ...
                  if (rc2)
                    sqlite33.SQLite3Error.toss(rc2);
                } catch (e) {
                  throw new sqlite33.SQLite3Error(
            ...
            "opfs-tree": async function(ev) {
              ...
              const response = await sqlite33.opfs.treeList();
              return response;
            }
          };
        ...
        }.bind({ self, sqlite3: sqlite32 });
      });
      "use strict";
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
        const wasm = sqlite32.wasm, capi2 = sqlite32.capi, toss = sqlite32.util.toss3;
        const vfs = /* @__PURE__ */ Object.create(null), vtab = /* @__PURE__ */ Object.create(null);
        const StructBinder = sqlite32.StructBinder;
        sqlite32.vfs = vfs;
        sqlite32.vtab = vtab;
        const sii = capi2.sqlite3_index_info;
        ...
        capi2.sqlite3_vfs.prototype.registerVfs = function(asDefault = false) {
          if (!(this instanceof sqlite32.capi.sqlite3_vfs)) {
            toss("Expecting a sqlite3_vfs-type argument.");
          }
          const rc = capi2.sqlite3_vfs_register(this, asDefault ? 1 : 0);
          if (rc) {
            toss("sqlite3_vfs_register(", this, ") failed with rc", rc);
          }
          if (this.pointer !== capi2.sqlite3_vfs_find(this.$zName)) {
            toss(
        ...
        vtab.xVtab = StructPtrMapper("xVtab", capi2.sqlite3_vtab);
        vtab.xCursor = StructPtrMapper("xCursor", capi2.sqlite3_vtab_cursor);
        vtab.xIndexInfo = (pIdxInfo) => new capi2.sqlite3_index_info(pIdxInfo);
        vtab.xError = function f(methodName, err2, defaultRc) {
          ...
          if (err2 instanceof sqlite32.WasmAllocError)
            rc = capi2.SQLITE_NOMEM;
          else if (arguments.length > 2)
            rc = defaultRc;
          else if (err2 instanceof sqlite32.SQLite3Error)
            rc = err2.resultCode;
          return rc || capi2.SQLITE_ERROR;
        };
        vtab.xError.errorReporter = 1 ? console.error.bind(console) : false;
        vtab.xRowid = (ppRowid64, value) => wasm.poke(ppRowid64, value, "i64");
        vtab.setupModule = function(opt) {
          let createdMod = false;
          const mod = this instanceof capi2.sqlite3_module ? this : opt.struct || (createdMod = new capi2.sqlite3_module());
          try {
        ...
        capi2.sqlite3_module.prototype.setupModule = function(opt) {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
        const installOpfsVfs = function callee(options) {
          ...
          const thePromise = new Promise(function(promiseResolve_, promiseReject_) {
            const loggers = {
              0: sqlite32.config.error,
              1: sqlite32.config.warn,
              2: sqlite32.config.log
            };
            ...
            const capi2 = sqlite32.capi;
            const wasm = sqlite32.wasm;
            const sqlite3_vfs = capi2.sqlite3_vfs;
            const sqlite3_file = capi2.sqlite3_file;
            const sqlite3_io_methods = capi2.sqlite3_io_methods;
            ...
            [
              ...
              if (void 0 === (state.sq3Codes[k] = capi2[k])) {
            ...
            const ioSyncWrappers = {
              ...
              xUnlock: function(pFile, lockType) {
                ...
                const f = __openFiles[pFile];
                let rc = 0;
                if (capi2.SQLITE_LOCK_NONE === lockType && f.lockType) {
            ...
            const vfsSyncWrappers = {
              ...
              xOpen: function f(pVfs, zName, pFile, flags, pOutFlags) {
                ...
                if (!rc) {
                  if (fh.readOnly) {
                    wasm.poke(pOutFlags, capi2.SQLITE_OPEN_READONLY, "i32");
                  }
            ...
            if (sqlite32.oo1) {
              ...
              sqlite32.oo1.DB.dbCtorHelper.setVfsPostOpenSql(
                opfsVfs.pointer,
                function(oo1Db, sqlite33) {
                  sqlite33.capi.sqlite3_busy_timeout(oo1Db, 1e4);
                  sqlite33.capi.sqlite3_exec(
                    oo1Db,
                    [
...
var toExportForESM = function() {
  ...
  globalThis.sqlite3InitModule = function ff(...args) {
    return originalInit(...args).then((EmscriptenModule) => {
      if ("undefined" !== typeof WorkerGlobalScope && (EmscriptenModule["ENVIRONMENT_IS_PTHREAD"] || EmscriptenModule["_pthread_self"] || "function" === typeof threadAlert || globalThis?.location?.pathname?.endsWith?.(".worker.js"))) {
...
var sqlite3_bundler_friendly_default = toExportForESM;

// ../../../Users/jarip/AppData/Local/deno/deno_esbuild/@sqlite.org/sqlite-wasm@3.42.0-build2/node_modules/@sqlite.org/sqlite-wasm/index.mjs
var sqlite_wasm_default = sqlite3_bundler_friendly_default;

// index.ts
var sqlite3 = await sqlite_wasm_default({
  locateFile(file) {
...
db.exec(["COMMIT"]);
if (typeof define_Deno_default !== "undefined") {
  define_Deno_default.bench("SelectObjects", () => {
    const rows = db.selectObjects("select * from person");
  });
  define_Deno_default.bench("SelectArrays", () => {
    const rows = db.selectArrays("select * from person");
  });
  define_Deno_default.bench("Step rows, get({})", () => {
